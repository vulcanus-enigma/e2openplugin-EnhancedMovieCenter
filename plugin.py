...
def Plugins(**kwargs):
	...
	descriptors.append( PluginDescriptor(name = "Enhanced Movie Center "+EMCVersion, description = "Enhanced Movie Center " +_("configuration"), icon = "/img/EnhancedMovieCenter.png", where = show_p, fnc = pluginOpen) )
